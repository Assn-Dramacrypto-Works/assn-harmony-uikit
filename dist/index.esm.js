...
var Icon$1i = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 204 204" }, props),
        React__default.createElement("image", { width: "204px", height: "204px", href: "/images/custom/site-logo-mobile.png" })));
};
...
var Logo$2 = function (_a) {
    ...
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 680 144" }, props),
        React__default.createElement("image", { width: "680px", height: "144px", href: "/images/custom/site-logo-desktop.png" })));
};
...
var Icon$_ = function (props) {
    return (React__default.createElement(Svg, __assign({ viewBox: "0 0 256 256" }, props),
        React__default.createElement("image", { width: "256px", height: "256px", href: "/images/custom/assn-token.png" })));
};
...
var CakePrice = function (_a) {
    ...
    return cakePriceUsd ? (React__default.createElement(PriceLink, { href: "https://bscscan.com/token/0x10ED88D78D6B2ac80B2A03a52e343828Ccc28682", target: "_blank" },
...
var MenuItem = function (_a) {
    ...
    return (React__default.createElement(StyledFooter, __assign({ p: ["40px 16px", null, "56px 40px 32px 40px"] }, props, { justifyContent: "center" }),
        React__default.createElement(Flex, { flexDirection: "column", width: ["100%", null, "1200px;"] },
            React__default.createElement(Flex, { order: [1, null, 1], flexDirection: ["column", null, "row"], justifyContent: "space-between", alignItems: "flex-start", mb: ["12px", null, "36px"] },
                React__default.createElement(Box, { display: ["block", null, "block"] },
                    React__default.createElement(LogoWithTextIcon, { isDark: true, width: "160px" }),
                    React__default.createElement(StyledSocialLinks, { order: [2], mb: ["16px", null, "32px"], mt: "12px" })), items === null || items === void 0 ? void 0 :
            ...
            React__default.createElement(StyledToolsContainer, { order: [2, null, 2], flexDirection: ["column", null, "row"], justifyContent: "space-between" },
                React__default.createElement(Flex, { order: [2, null, 1], alignItems: "center" },
                    React__default.createElement(Text, { color: "textSubtle", fontSize: "14px" }, "ASSN Finance @2022")),
                React__default.createElement(Flex, { order: [1, null, 2], mb: ["24px", null, "0"], justifyContent: "space-between", alignItems: "center" },
                    ...
                    React__default.createElement(Button, { as: "a", href: "https://assn.finance//swap?outputCurrency=0x0e09fabb73bd3ade0a17ecc321fd13a19e81ce82", target: "_blank", scale: "sm", endIcon: React__default.createElement(Icon$29, { color: lightColors.backgroundAlt }) }, buyCakeLabel))))));
};
...
var Logo = function (_a) {
    ...
    return (React__default.createElement(Flex, null, isAbsoluteUrl ? (React__default.createElement(StyledLink, { as: "a", href: href, "aria-label": "ASSN home page" }, innerLogo)) : (React__default.createElement(StyledLink, { to: href, "aria-label": "ASSN home page" }, innerLogo))));
};
